...
document.getElementById('rep-nex-Box-left').onclick = function () {
    ...
    if ($bannerMain.style.backgroundImage.indexOf('banner-2') === -1 && $bannerMain.style.backgroundImage.indexOf('banner-3') === -1 && $bannerMain.style.backgroundImage.indexOf('banner-4') === -1){
