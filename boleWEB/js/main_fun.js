...
$(function() {
    ...
    document.addEventListener('touchmove', function (e) { if(menu_opened) e.preventDefault(); }, false);
    ...
    $('form.w3-container').submit(function(e) {
        e.preventDefault();
        var $form = $(this), data = objectifyForm($form.serializeArray());
        $.ajaxSetup({
            headers: {
